...
## 探査
    ...
    execute positioned ^ ^ ^0.32 if block ^ ^ ^0.32 #zz.pm_motion:through rotated ~180 ~ if block ^ ^ ^0.32 #zz.pm_motion:through if block ^ ^ ^-0.32 #zz.pm_motion:through rotated as 4fe002bb-0-0-0-1 if block ^ ^ ^0.32 #zz.pm_motion:through if block ^ ^ ^-0.32 #zz.pm_motion:through rotated ~180 ~ if block ^ ^ ^0.32 #zz.pm_motion:through if block ^ ^ ^-0.32 #zz.pm_motion:through run scoreboard players set #pmmH.ray064 pmmS. -1
    execute if score #pmmH.ray064 pmmS. matches -1 positioned ^ ^ ^0.32 positioned ~-0.32 ~-0.32 ~-0.32 as @e[type=!#zz.pm_motion:through,tag=!pmmT.through,dx=0,dy=0,dz=0] positioned ~-0.36 ~-0.36 ~-0.36 if entity @s[dx=0,dy=0,dz=0] run scoreboard players set #pmmH.ray064 pmmS. 2
    # さらに細かくチェック
    ...
    execute if score #pmmH.1 pmmS.distance matches 1.. if score #pmmH.ray064 pmmS. matches 0.. positioned ^ ^ ^0.32 run function zz.pm_motion:ray/032

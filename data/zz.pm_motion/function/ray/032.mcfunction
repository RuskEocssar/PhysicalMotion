...
## 探査
    ...
    execute positioned ^ ^ ^0.16 if block ^ ^ ^0.16 #zz.pm_motion:through rotated ~180 ~ if block ^ ^ ^0.16 #zz.pm_motion:through if block ^ ^ ^-0.16 #zz.pm_motion:through rotated as 4fe002bb-0-0-0-1 if block ^ ^ ^0.16 #zz.pm_motion:through if block ^ ^ ^-0.16 #zz.pm_motion:through rotated ~180 ~ if block ^ ^ ^0.16 #zz.pm_motion:through if block ^ ^ ^-0.16 #zz.pm_motion:through run scoreboard players set #pmmH.ray032 pmmS. -1
    execute if score #pmmH.ray032 pmmS. matches -1 positioned ^ ^ ^0.16 positioned ~-0.16 ~-0.16 ~-0.16 as @e[type=!#zz.pm_motion:through,tag=!pmmT.through,dx=0,dy=0,dz=0] positioned ~-0.68 ~-0.68 ~-0.68 if entity @s[dx=0,dy=0,dz=0] run scoreboard players set #pmmH.ray032 pmmS. 2
    # さらに細かくチェック
    ...
    execute if score #pmmH.1 pmmS.distance matches 1.. if score #pmmH.ray032 pmmS. matches 0.. positioned ^ ^ ^0.16 run function zz.pm_motion:ray/016

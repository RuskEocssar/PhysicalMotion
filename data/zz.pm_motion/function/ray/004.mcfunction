...
## 探査
    ...
    # 角8方向に探査点を伸ばしてチェック
    execute if data storage pm_motion:zz data{block:false} run scoreboard players set #pmmH.ray004 pmmS. -1
    execute unless data storage pm_motion:zz data{block:false} positioned ^ ^ ^0.02 if block ~0.02 ~0.02 ~0.02 #pm_motion:through if block ~0.02 ~0.02 ~-0.02 #pm_motion:through if block ~0.02 ~-0.02 ~0.02 #pm_motion:through if block ~0.02 ~-0.02 ~-0.02 #pm_motion:through if block ~-0.02 ~0.02 ~0.02 #pm_motion:through if block ~0.02 ~0.02 ~-0.02 #pm_motion:through if block ~-0.02 ~-0.02 ~0.02 #pm_motion:through if block ~-0.02 ~-0.02 ~-0.02 #pm_motion:through run scoreboard players set #pmmH.ray004 pmmS. -1
    execute if score #pmmH.ray004 pmmS. matches -1 unless data storage pm_motion:zz data{entity:false} positioned ^ ^ ^0.02 positioned ~-0.02 ~-0.02 ~-0.02 as @e[predicate=!zz.pm_motion:through_entity,dx=0,dy=0,dz=0] positioned ~-0.96 ~-0.96 ~-0.96 if entity @s[dx=0,dy=0,dz=0] positioned ~0.48 ~0.48 ~0.48 positioned ^ ^ ^-0.52 unless entity @s[dx=0,dy=0,dz=0] run function zz.pm_motion:ray/entity/004

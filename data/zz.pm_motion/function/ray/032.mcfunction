...
## 探査
    ...
    execute unless data storage pm_motion:zz data{block:false} positioned ^ ^ ^0.16 if block ~0.16 ~0.16 ~0.16 #pm_motion:through if block ~0.16 ~0.16 ~-0.16 #pm_motion:through if block ~0.16 ~-0.16 ~0.16 #pm_motion:through if block ~0.16 ~-0.16 ~-0.16 #pm_motion:through if block ~-0.16 ~0.16 ~0.16 #pm_motion:through if block ~0.16 ~0.16 ~-0.16 #pm_motion:through if block ~-0.16 ~-0.16 ~0.16 #pm_motion:through if block ~-0.16 ~-0.16 ~-0.16 #pm_motion:through run scoreboard players set #pmmH.ray032 pmmS. -1
    execute if score #pmmH.ray032 pmmS. matches -1 unless data storage pm_motion:zz data{entity:false} positioned ^ ^ ^0.16 positioned ~-0.16 ~-0.16 ~-0.16 as @e[predicate=!zz.pm_motion:through_entity,dx=0,dy=0,dz=0] positioned ~-0.68 ~-0.68 ~-0.68 if entity @s[dx=0,dy=0,dz=0] positioned ~0.34 ~0.34 ~0.34 positioned ^ ^ ^-0.66 unless entity @s[dx=0,dy=0,dz=0] run function zz.pm_motion:ray/entity/032

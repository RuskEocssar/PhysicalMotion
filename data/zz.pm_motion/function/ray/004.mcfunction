...
## 探査
    ...
    execute if score #pmmH.ray004 pmmS. matches -1 unless data storage pm_motion:zz data{entity:false} positioned ^ ^ ^0.02 positioned ~-0.02 ~-0.02 ~-0.02 as @e[type=!#zz.pm_motion:through,tag=!pm_through,dx=0,dy=0,dz=0] positioned ~-0.96 ~-0.96 ~-0.96 if entity @s[dx=0,dy=0,dz=0] positioned ~0.48 ~0.48 ~0.48 positioned ^ ^ ^-0.52 unless entity @s[dx=0,dy=0,dz=0] run function zz.pm_motion:ray/entity/004

...
## 探査
    ...
    execute unless data storage pm_motion:zz data{block:false} positioned ^ ^ ^0.01 if block ~0.01 ~0.01 ~0.01 #pm_motion:through if block ~0.01 ~0.01 ~-0.01 #pm_motion:through if block ~0.01 ~-0.01 ~0.01 #pm_motion:through if block ~0.01 ~-0.01 ~-0.01 #pm_motion:through if block ~-0.01 ~0.01 ~0.01 #pm_motion:through if block ~0.01 ~0.01 ~-0.01 #pm_motion:through if block ~-0.01 ~-0.01 ~0.01 #pm_motion:through if block ~-0.01 ~-0.01 ~-0.01 #pm_motion:through run scoreboard players set #pmmH.ray002 pmmS. -1
    execute if score #pmmH.ray002 pmmS. matches -1 unless data storage pm_motion:zz data{entity:false} positioned ^ ^ ^0.01 positioned ~-0.01 ~-0.01 ~-0.01 as @e[predicate=!zz.pm_motion:through_entity,dx=0,dy=0,dz=0] positioned ~-0.98 ~-0.98 ~-0.98 if entity @s[dx=0,dy=0,dz=0] positioned ~0.49 ~0.49 ~0.49 positioned ^ ^ ^-0.51 unless entity @s[dx=0,dy=0,dz=0] run function zz.pm_motion:ray/entity/002

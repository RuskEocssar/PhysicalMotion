...
## 探査
    ...
    execute if score #pmmH.ray008 pmmS. matches -1 positioned ^ ^ ^0.04 positioned ~-0.04 ~-0.04 ~-0.04 as @e[type=!#zz.pm_motion:through,dx=0,dy=0,dz=0] positioned ~-0.92 ~-0.92 ~-0.92 if entity @s[dx=0,dy=0,dz=0] positioned ~0.46 ~0.46 ~0.46 positioned ^ ^ ^-0.54 unless entity @s[dx=0,dy=0,dz=0] run function zz.pm_motion:ray/entity/008

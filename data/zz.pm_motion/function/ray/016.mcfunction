...
## 探査
    ...
    execute if score #pmmH.ray016 pmmS. matches -1 positioned ^ ^ ^0.08 positioned ~-0.08 ~-0.08 ~-0.08 as @e[type=!#zz.pm_motion:through,tag=!pmmT.through,dx=0,dy=0,dz=0] positioned ~-0.84 ~-0.84 ~-0.84 if entity @s[dx=0,dy=0,dz=0] run function zz.pm_motion:ray/entity/016
